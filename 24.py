            ...
            for k1 in range(0,6):
                ...
                for i3 in range(0, 2):
                    ...
                    for k2 in range(0,6):
                        ...
                        result4 = calc(num3,num4,k2)
                        for k3 in range(0,6):
                            result3 = calc(result2,num4,k3)
                            result5 = calc(result1,result4,k3)
                            if result3 < 24.0001 and result3 > 23.9999:
                                ...
                                print('')
                            if result5 < 24.0001 and result5 > 23.9999:
                                i=i+1
                                print('第',i,'组解:')
                                if k1==5 or k1==4:
                                    print(num2,sym[k1],num1,'=',"{:.2f}".format(result1))
                                    ...
                                    print(num1,sym[k1],num2,'=',"{:.2f}".format(result1))
                                if k2==5 or k2==4:
                                    print(num4,sym[k2],num3,'=',"{:.2f}".format(result4))
                                else:
                                    print(num3,sym[k2],num4,'=',"{:.2f}".format(result4))
                                if k3==5 or k3==4:
                                    print("{:.2f}".format(result4),sym[k3],"{:.2f}".format(result1),'=',24)
                                else:
                                    print("{:.2f}".format(result1),sym[k3],"{:.2f}".format(result4),'=',24)
                                print('')
    if i == 0:
        print("无实数解")
main()
